...
test.only('date.mob.range.1: Date label should show 2013-03-15', async () => {
  const { mobileDatePickerSelectBtn } = selectors
...
test.only('date.mob.range.2: mobile selector header should show 2013 MAR 15', async () => {
...
test.only('date.mob.range.3: Date label should show 2012 MAR 15 after year drag', async () => {
...
test.only('date.mob.range.4: Date in header should be 2012 JAN 15 after month drag', async () => {
  const { mobileDatePickerHeader } = selectors
...
test.only('date.mob.range.5: Date in header should be 2012 JAN 19 after day drag', async () => {
  const { mobileDatePickerHeader } = selectors
