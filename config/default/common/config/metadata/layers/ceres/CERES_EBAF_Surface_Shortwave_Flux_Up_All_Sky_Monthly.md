The CERES Surface Shortwave Flux (Monthly, Energy Balanced and Filled, Up, All-Sky) layer shows the EBAF Monthly Mean parameterized broadband shortwave (0.2-5 µm upwelling (up, defined as positive) flux at the Earth’s surface, for all-sky conditions (W/m<sup>2</sup>). CERES footprints (20 km nominal resolution) are classified as clear if they contain 99% of pixels identified as clear by the CERES-MODIS clear-sky mask.
