...
References: [NASA Earth Observatory - Blue Marble](https://science.nasa.gov/earth/earth-observatory/blue-marble-next-generation/); [NASA Earth Observations - Blue Marble](https://neo.gsfc.nasa.gov/view.php?datasetId=BlueMarbleNG-TB); [NASA Earth Observations - Blue Marble: Next Generation+Topography and Bathymetry](https://neo.gsfc.nasa.gov/view.php?datasetId=BlueMarbleNG-TB)
