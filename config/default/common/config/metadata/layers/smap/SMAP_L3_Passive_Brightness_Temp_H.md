The Soil Moisture Active Passive (SMAP) "Corrected Brightness Temperature" layer displays brightness temperatures (TBs) in Kelvin (K) for the horizontal (H) polarization from the SMAP radiometer.
