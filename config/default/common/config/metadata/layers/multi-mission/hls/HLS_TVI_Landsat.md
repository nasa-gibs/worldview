...
The dynamically generated Triangular Vegetation Index imagery layer is good for estimating green leaf area index (LAI), but its sensitivity to chlorophyll increases with an increase in canopy density. TVI is calculated using TVI = 120(NIR - Green) - 200(Red-Green) / 2, and specifically for Landsat 8 and 9, TVI = 120(Band 5 – Band 3) - 200(Band 4 - Band 3) / 2.
