module.exports = (page) => ({
  ...
  animateYearUp: page.locator('#wv-animation-widget .input-wrapper-year .date-arrow-up'),
  animateYearDown: page.locator('#wv-animation-widget .input-wrapper-year .date-arrow-down'),
