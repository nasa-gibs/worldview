module.exports = (page) => ({
  ...
  // layers
  layersAll3rdElement: page.locator('#legacy-all li.layer-category-item:nth-of-type(3)'),
  layersAll4thElement: page.locator('#legacy-all li.layer-category-item:nth-of-type(4)'),
  layersList1stCheckbox: page.locator('ul:nth-of-type(1) li:nth-of-type(1) input'),
  ...
  crAquaModisTab: page.locator('#aqua-modis-0-source-Nav'),
  crTerraModisTab: page.locator('#terra-modis-4-source-Nav'),
  crAllMeasurement: page.locator('#layer-category-item-legacy-all-corrected-reflectance'),
  crScientificAllMeasurement: page.locator('#layer-category-item-scientific-all-corrected-reflectance'),
  crCheckboxMODISTrueColor: page.locator('#MODIS_Aqua_CorrectedReflectance_TrueColor-checkbox'),
  crCheckboxMODISBands721: page.locator('#MODIS_Aqua_CorrectedReflectance_Bands721-checkbox'),
  crCheckboxOrbitAscending: page.locator('#OrbitTracks_Aqua_Ascending-checkbox'),
  crCheckboxTerraBands367: page.locator('#MODIS_Terra_CorrectedReflectance_Bands367-checkbox'),
  crSidebarMODISTrueColorLayer: page.locator('#active-MODIS_Aqua_CorrectedReflectance_TrueColor'),
  ...
  crAquaModisHeader: page.locator('#modiscorrectedreflectancevsmodissurfacereflectance'),
  ...
  measurementBrightnessTemperatureLabel: page.locator('#measurements-facet [for="example_facet_MeasurementsBrightness Temperature"]'),
  measurementSeaSurfaceTemperatureLabel: page.locator('#measurements-facet [for="example_facet_MeasurementsSea Surface Temperature"]'),
