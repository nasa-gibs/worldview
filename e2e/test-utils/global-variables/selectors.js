module.exports = (page) => ({
  ...
  gifPreviewEndResolutionOption250: page.locator('#gif-resolution option[value="250"]'),
  gifPreviewEndResolutionOption500: page.locator('#gif-resolution option[value="500"]'),
  ...
  dayDown: page.locator('#date-selector-main .input-wrapper-day > button.date-arrows.date-arrow-down'),
  dayUp: page.locator('#date-selector-main .input-wrapper-day > button.date-arrows.date-arrow-up'),
  monthDown: page.locator('#date-selector-main .input-wrapper-month > button.date-arrows.date-arrow-down'),
  monthUp: page.locator('#date-selector-main .input-wrapper-month > button.date-arrows.date-arrow-up'),
  yearDown: page.locator('#date-selector-main .input-wrapper-year > button.date-arrows.date-arrow-down'),
  yearUp: page.locator('#date-selector-main .input-wrapper-year > button.date-arrows.date-arrow-up'),
  ...
  mobileDatePickerHeader: page.locator('.datepicker-modal .datepicker .datepicker-header .datepicker-header'),
  ...
  aquaTerraMODISTab: page.locator('#aqua-terra-modis-1-source-Nav'),
  aquaModisTab: page.locator('#aqua-modis-2-source-Nav'),
