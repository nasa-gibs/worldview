module.exports = {
  ...
  selectors: {
    ...
    'GIF preview resolution selector': '.gif-selector-case #gif-resolution',
    'GIF preview resolution option 250m': '#gif-resolution option[value="1"]',
    'GIF download icon': '.jcrop-holder .fa-download',
    'GIF download button': '.animation-gif-dialog-wrapper .wv-button',
