...
test('Move AOD over the reference features', async () => {
  ...
  await page.goto(url)
  console.warn('url loaded')
  await page.waitForTimeout(1000)
  console.warn('waited 1 sec')
  await modalCloseButton.click()
  console.warn('modalCloseButton clicked')
  await page.waitForTimeout(1000)
  console.warn('waited 1 sec')
  await openImageDownloadPanel(page)
  console.warn('openImageDownloadPanel done')
  await clickDownload(page)
  console.warn('clickDownload done')
  const urlAttribute = await getAttribute(page, '#wv-image-download-url', 'url')
  console.warn('urlAttribute', urlAttribute)
