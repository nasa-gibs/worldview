...
test.skip('List layers in draw order', async () => {
...
test.skip('Move AOD over the reference features', async ({ browserName }) => {
...
test.skip('Do not include obscured layers', async () => {
  const url = await joinUrl(startParams, '&l=MODIS_Terra_CorrectedReflectance_TrueColor,MODIS_Terra_Aerosol,Reference_Features_15m')
  await page.goto(url)
  await closeModal(page)
  await openImageDownloadPanel(page)
...
test.skip('Multiple base layers when one is semi-transparent', async () => {
