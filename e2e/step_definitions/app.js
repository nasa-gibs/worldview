...
defineSupportCode(({Given, Then, When}) => {
  ...
  When('I scroll to the {string}', function (label) {
  ...
  When('I input {string} in the {string}', function(value, label) {
    return client.useCss().setValue(selectors[label], value);
  });

  // Wait until an element is visible
  When('I wait to see {string}', function(label) {
