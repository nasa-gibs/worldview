...
| mockAlerts | string | Use a static JSON file by passing the notification type: `alert`, `message`, `outage`, or `all_types`. Local sources can be found at mock/notify_{string}.json |
