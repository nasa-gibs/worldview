// This is a fork of d3@3.4.11 with the changes in this commit: https://github.com/d3/d3/pull/2019/files
!function() {
  var d3 = {
    version: "3.4.11"
  };
  ...
  d3.behavior.zoom = function() {
    var view = {
      ...
      y: 0,
      k: 1
    }, translate0, center0, center, size = [ 960, 500 ], scaleExtent = d3_behavior_zoomInfinity, xExtent = d3_behavior_scaleInfinity, yExtent = d3_behavior_scaleInfinity, mousedown = "mousedown.zoom", mousemove = "mousemove.zoom", mouseup = "mouseup.zoom", mousewheelTimer, touchstart = "touchstart.zoom", touchtime, event = d3_eventDispatch(zoom, "zoomstart", "zoom", "zoomend"), x0, x1, y0, y1;
    function zoom(g) {
