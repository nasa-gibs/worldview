...
MapUI.propTypes = {
  ...
  activeLayersState: PropTypes.shape,
  ...
  renderableLayersState: PropTypes.shape,
  selectedDate: PropTypes.shape,
  selectedDateB: PropTypes.shape,
  setPreload: PropTypes.func,
  setUI: PropTypes.func,
  ui: PropTypes.shape,
  updateMapExtent: PropTypes.func,
  vectorStyles: PropTypes.shape,
  vectorStylesState: PropTypes.shape,
};
