...
function AnimationButton(props) {
  ...
  return (
    <div
      ...
      className={isKioskModeActive ? 'd-none' : disabled ? 'wv-disabled-button button-action-group animate-button' : !isMobile && !isEmbedModeActive ? 'button-action-group animate-button' : `button-action-group button-action-group-margin-fix mobile-animate-button animate-button-${buttonClass}`}
