  ...
  return (
    <div className="basic-modal">
      ...
      <p>
        ...
        {' '}
        and then &quot;backfilled&quot; by the corresponding Standard (STD)
        product when it is available. @NAME@ displays them on a
      ...
      <p>
        Often layers will have both NRT and STD collections available for download in Earthdata
        Search. If you are looking for data within the last ~7 days you will likely want to use the
        NRT collection.  If you have the NRT collection selected and the granule count shows
        &quot;NONE&quot;, this may be an indication that your selected date is too far in the past
        and you may have better luck with the STD collection.
      </p>
      ...
      <ol>
        ...
        <li>
          The area of interest is encompassing imagery but the collection&apos;s metadata record
          does not contain the appropriate spatial information for this feature to work. Unchecking
