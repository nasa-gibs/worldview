      ...
      <div className="tour-box-container">
        <div className="tour-box-row">
          {storyOrder.map(function(storyId, i) {
            ...
            return (<TourBox key={i} index={i} story={story} storyId={story.id} title={story.title} description={story.description} backgroundImage={story.backgroundImage} backgroundImageHover={story.backgroundImageHover} startTour={startTour} className={'tour-box ' + story.type}/>);
          })}
        </div>
      </div>
    );
