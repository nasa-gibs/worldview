...
describe('main modalReducer', () => {
  ...
  test(`${constants.TOGGLE}action type should toggle open value [modal-reducers-toggle]`, () => {
  ...
  test(
    `${constants.OPEN_BASIC}action type should update various modal props [modal-reducers-open]`,
    () => {
  ...
  test(
    `${constants.OPEN_CUSTOM} action type should update various modal props [modal-reducers-open-custom]`,
    () => {
  ...
  test(
    ...
    } action type should update various modal props [modal-reducers-render-template]`,
    () => {
      const template = '<html>';
      const modalCustomObject = lodashAssign({}, modalState, {
