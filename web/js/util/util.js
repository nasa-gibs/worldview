...
export default (function (self) {
  ...
  self.rgbaToShortHex = function(rgba) {
    ...
    var r = parseInt(self.trim(parts[0].substring(1)), 10);
    var g = parseInt(self.trim(parts[1]), 10);
    var b = parseInt(self.trim(parts[2]), 10);
    var a = parseFloat(self.trim(parts[3].substring(0, parts[3].length - 1))).toFixed(2);
