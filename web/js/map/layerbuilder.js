    ...
    const vectorSource = new OlSourceVector({
      ...
      loader: async () => {
        ...
        const getActiveData = async () => {
          ...
          const urlParameters = `?year=${date.getFullYear()}&month=${date.getMonth() + 1}&day=${date.getDate()}&year2=${date.getFullYear()}&month2=${date.getMonth() + 1}&day2=${date.getDate()}&AOD15=1&AVG=${avg}&if_no_html=1`;
