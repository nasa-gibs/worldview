...
// COMPONENT
export default function EventTrack (props) {
  ...
  const {
    ...
    isAnimatingToEvent: state.events.isAnimatingToEvent,
  ...
  const removeTrack = function(map) {
   ...
   * @param  {String} selectedDate
   */
  const update = function(event, date) {
    let newTrackDetails;
