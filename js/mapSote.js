...
SOTE.widget.MapSote.prototype.addProductToMap = function(product, state)
{
	...
	if(this.state == "geographic")
	{
		layersToAdd = [
			...
			(product == "sedac_bound_nogray") ? [{displayName: "sedac_bound_nogray", wmsProductName: "sedac_bound_nogray", time:"", format: "image/png", urls:["http://map1a.vis.earthdata.nasa.gov/wmts-geo/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-geo/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-geo/wmts.cgi"], tileSize:[512,512], projection:"EPSG:4326", numZoomLevels:9, maxExtent:[-180,-1350,180,90], maxResolution:0.5625, preferredOpacity: 0.90, bringToFront: true, transitionEffect:"none" }] : [],
	...
	{
		layersToAdd = [
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_CorrectedReflectance_TrueColor", "MODIS_Terra_CorrectedReflectance_TrueColor", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_CorrectedReflectance_TrueColor", "MODIS_Aqua_CorrectedReflectance_TrueColor", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_CorrectedReflectance_Bands367", "MODIS_Terra_CorrectedReflectance_Bands367", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m),

			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_Brightness_Temp_Band31_Day", "MODIS_Terra_Brightness_Temp_Band31_Day", "image/png", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_Brightness_Temp_Band31_Night", "MODIS_Terra_Brightness_Temp_Band31_Night", "image/png", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			...
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_Brightness_Temp_Band31_Night", "MODIS_Aqua_Brightness_Temp_Band31_Night", "image/png", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_Snow_Cover", "MODIS_Terra_Snow_Cover", "image/png", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_500m),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_Snow_Cover", "MODIS_Aqua_Snow_Cover", "image/png", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_500m),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_Sea_Ice", "MODIS_Terra_Sea_Ice", "image/png", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_Sea_Ice", "MODIS_Aqua_Sea_Ice", "image/png", ["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),		

			// Commented out until polar WMTSes are ready
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Terra_CorrectedReflectance_TrueColor", "MODIS_Terra_CorrectedReflectance_TrueColor", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/wmts-arctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-arctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-arctic/wmts.cgi"], [512,512], "EPSG:3995", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m, this.TILEMATRIXSET_ARCTIC_250m),
...
// 
			...
			// (product == "arctic_coastlines") ? [{displayName: "arctic_coastlines", wmsProductName: "arctic_coastlines", time:"", format: "image/png", urls:["http://map1a.vis.earthdata.nasa.gov/wmts-arctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-arctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-arctic/wmts.cgi"], tileSize:[512,512], projection:"EPSG:3995", numZoomLevels:6, maxExtent:[-4194300,-4194200,4194200,4194300], maxResolution:8192.0, tileMatrixSet: this.TILEMATRIXSET_ARCTIC_250m, resolutions: RESOLUTIONS_ON_SCREEN_POLAR_ALL, serverResolutions: RESOLUTIONS_ON_SERVER_POLAR_250m, preferredOpacity: 1.0, bringToFront: true, transitionEffect:"none" }] : [],

			(product == "arctic_coastlines") ? [{displayName: "arctic_coastlines", wmsProductName: "arctic_coastlines", time:"", format: "image/png", urls:["http://map1a.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/arctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/arctic/wms.cgi"], tileSize:[512,512], projection:"EPSG:3995", numZoomLevels:6, maxExtent:[-4194300,-4194200,4194200,4194300], maxResolution:8192.0, resolutions: this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, serverResolutions: this.RESOLUTIONS_ON_SERVER_POLAR_250m, preferredOpacity: 1.0, bringToFront: true, transitionEffect:"none" }] : [],
	...
	{
		layersToAdd = [
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_CorrectedReflectance_TrueColor", "MODIS_Terra_CorrectedReflectance_TrueColor", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_CorrectedReflectance_TrueColor", "MODIS_Aqua_CorrectedReflectance_TrueColor", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_CorrectedReflectance_Bands367", "MODIS_Terra_CorrectedReflectance_Bands367", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m),

			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_Brightness_Temp_Band31_Day", "MODIS_Terra_Brightness_Temp_Band31_Day", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_Brightness_Temp_Band31_Night", "MODIS_Terra_Brightness_Temp_Band31_Night", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_Brightness_Temp_Band31_Day", "MODIS_Aqua_Brightness_Temp_Band31_Day", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_Brightness_Temp_Band31_Night", "MODIS_Aqua_Brightness_Temp_Band31_Night", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_Snow_Cover", "MODIS_Terra_Snow_Cover", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_500m),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_Snow_Cover", "MODIS_Aqua_Snow_Cover", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_500m),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Terra_Sea_Ice", "MODIS_Terra_Sea_Ice", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "MODIS_Aqua_Sea_Ice", "MODIS_Aqua_Sea_Ice", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),
			SOTE.util.generateProductLayersForDateRange(product, "NSIDC_Sea_Ice_Concentration", "NSIDC_Sea_Ice_Concentration", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),

			// Commented out until polar WMTSes are ready
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Terra_CorrectedReflectance_TrueColor", "MODIS_Terra_CorrectedReflectance_TrueColor", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m, this.TILEMATRIXSET_ANTARCTIC_250m),
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Aqua_CorrectedReflectance_TrueColor", "MODIS_Aqua_CorrectedReflectance_TrueColor", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m, this.TILEMATRIXSET_ANTARCTIC_250m),
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Terra_CorrectedReflectance_Bands367", "MODIS_Terra_CorrectedReflectance_Bands367", "image/jpeg", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_250m, this.TILEMATRIXSET_ANTARCTIC_250m),
// 
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Terra_Brightness_Temp_Band31_Day", "MODIS_Terra_Brightness_Temp_Band31_Day", "image/png", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km, this.TILEMATRIXSET_ANTARCTIC_1km),
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Terra_Brightness_Temp_Band31_Night", "MODIS_Terra_Brightness_Temp_Band31_Night", "image/png", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km, this.TILEMATRIXSET_ANTARCTIC_1km),
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Aqua_Brightness_Temp_Band31_Day", "MODIS_Aqua_Brightness_Temp_Band31_Day", "image/png", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km, this.TILEMATRIXSET_ANTARCTIC_1km),
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Aqua_Brightness_Temp_Band31_Night", "MODIS_Aqua_Brightness_Temp_Band31_Night", "image/png", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km, this.TILEMATRIXSET_ANTARCTIC_1km),
// 
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Terra_Snow_Cover", "MODIS_Terra_Snow_Cover", "image/png", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km, this.TILEMATRIXSET_ANTARCTIC_500m),
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Aqua_Snow_Cover", "MODIS_Aqua_Snow_Cover", "image/png", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km, this.TILEMATRIXSET_ANTARCTIC_500m),
// 
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Terra_Sea_Ice", "MODIS_Terra_Sea_Ice", "image/png", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km, this.TILEMATRIXSET_ANTARCTIC_1km),
			// SOTE.util.generateProductLayersForDateRangeTMS(product, "MODIS_Aqua_Sea_Ice", "MODIS_Aqua_Sea_Ice", "image/png", ["http://map1a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map1c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km, this.TILEMATRIXSET_ANTARCTIC_1km),

			// (product == "antarctic_coastlines") ? [{displayName: "antarctic_coastlines", wmsProductName: "antarctic_coastlines", time:"", format: "image/png", urls:["http://map2a.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map2b.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi", "http://map2c.vis.earthdata.nasa.gov/wmts-antarctic/wmts.cgi"], tileSize:[512,512], projection:"EPSG:3031", numZoomLevels:6, maxExtent:[-4194300,-4194200,4194200,4194300], maxResolution:8192.0, tileMatrixSet: this.TILEMATRIXSET_ANTARCTIC_250m, resolutions: RESOLUTIONS_ON_SCREEN_POLAR_ALL, serverResolutions: RESOLUTIONS_ON_SERVER_POLAR_250m, preferredOpacity: 1.0, bringToFront: true, transitionEffect:"none" }] : [],

			// SOTE.util.generateProductLayersForDateRange(product, "NSIDC_Sea_Ice_Concentration", "NSIDC_Sea_Ice_Concentration", "image/png", ["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], [512,512], "EPSG:3031", 6, [-4194300,-4194200,4194200,4194300], 8192.0, 1.0, this.NUM_DAYS_TO_GENERATE, this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, this.RESOLUTIONS_ON_SERVER_POLAR_1km),

			(product == "antarctic_coastlines") ? [{displayName: "antarctic_coastlines", wmsProductName: "antarctic_coastlines", time:"", format: "image/png", urls:["http://map1a.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1b.vis.earthdata.nasa.gov/antarctic/wms.cgi", "http://map1c.vis.earthdata.nasa.gov/antarctic/wms.cgi"], tileSize:[512,512], projection:"EPSG:3031", numZoomLevels:6, maxExtent:[-4194300,-4194200,4194200,4194300], maxResolution:8192.0, resolutions: this.RESOLUTIONS_ON_SCREEN_POLAR_ALL, serverResolutions: this.RESOLUTIONS_ON_SERVER_POLAR_250m, preferredOpacity: 1.0, bringToFront: true, transitionEffect:"none" }] : [],
