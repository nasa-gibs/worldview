...
SOTE.widget.MapSote.prototype.addProductToMap = function(product, state)
{
	...
	else if (this.state == "arctic")
	{
		layersToAdd = [
			...
			(product == "polarview:coastArctic10") ? [{displayName: "polarview:coastArctic10", wmsProductName: "polarview:coastArctic10", time:"", urls:["http://geos.polarview.aq/geoserver/wms?"], layers:"polarview:coastArctic10", transparent:true, projection:"EPSG:3995", preferredOpacity: 0.95, bringToFront: true }] : [],
	...
	else if (this.state == "antarctic")
	{
		layersToAdd = [
			...
			(product == "polarview:coastS10") ? [{displayName: "polarview:coastS10", wmsProductName: "polarview:coastS10", time:"", urls:["http://geos.polarview.aq/geoserver/wms?"], layers:"polarview:coastS10", transparent:true, projection:"EPSG:3031", preferredOpacity: 0.85, bringToFront: true }] : [],
