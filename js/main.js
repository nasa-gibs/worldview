$(function() {// Initialize "static" vars
    ...
    var onConfigLoad = function(config) {  	    	            	    	            	    	            	    	    	    	            	    	    
        ...
        var a = new SOTE.widget.Bank("products",{paletteManager: palettes, dataSourceUrl:"ap_products.php",title:"My Layers",selected:{antarctic:"baselayers,MODIS_Terra_CorrectedReflectance_TrueColor~overlays,antarctic_coastlines", arctic:"baselayers,MODIS_Terra_CorrectedReflectance_TrueColor~overlays,arctic_coastlines",geographic:"baselayers,MODIS_Terra_CorrectedReflectance_TrueColor~overlays,sedac_bound_nogray"},categories:["Base Layers","Overlays"],callback:showSelector,selector:selector});
